...
begin 
  ...
  --------------------------------------------------------------------
  -- Vector pipeline regs (flush bubble = all 0s)
  --------------------------------------------------------------------

  IDEX_funct3_Register: PipelineRegister_Flush
    generic map(N => 3)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
      i_FLUSH => i_flush_IDEX,
      i_D     => IDEX_funct3,
      o_Q     => IDEX_funct3_out
    );

  IDEX_WriteBack_Register: PipelineRegister_Flush
    generic map(N => 5)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_rs1_Register: PipelineRegister_Flush
    generic map(N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_rs1_address_Register: PipelineRegister_Flush
    generic map(N => 5)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_rs2_address_Register: PipelineRegister_Flush
    generic map(N => 5)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_rs2_Register: PipelineRegister_Flush
    generic map(N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_immGen_Register: PipelineRegister_Flush
    generic map(N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_AndLink_Register: PipelineRegister_Flush
    generic map(N => 2)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_FlagMux_Register: PipelineRegister_Flush
    generic map(N => 2)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_ALUControl_Register: PipelineRegister_Flush
    generic map(N => 4)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_PC_Register: PipelineRegister_Flush
    generic map(N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  IDEX_PC4_Register: PipelineRegister_Flush
    generic map(N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  --------------------------------------------------------------------
  -- 1-bit controls (bubble = 0)
  --------------------------------------------------------------------

  IDEX_Branch_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_WriteEnable_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_Halt_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_Jump_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_FlagNFlag_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_MemWrite_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_MemToReg_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_ALUSrc_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_Shift_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_JumpWithReg_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  IDEX_ALU_or_Imm_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
