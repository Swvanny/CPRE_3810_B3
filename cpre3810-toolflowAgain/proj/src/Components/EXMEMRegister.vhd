...
begin
  ...
  EXMEM_funct3_Register: PipelineRegister_Flush
    generic map (N => 3)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
      i_FLUSH => i_flush_EXMEM,
      i_D     => EXMEM_funct3,
      o_Q     => EXMEM_funct3_out
    );

  EXMEM_WriteBack_Register: PipelineRegister_Flush
    generic map (N => 5)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_RS2_Register: PipelineRegister_Flush
    generic map (N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_ALUOut_Register: PipelineRegister_Flush
    generic map (N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_PC4_Register: PipelineRegister_Flush
    generic map (N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_barrel_Register: PipelineRegister_Flush
    generic map (N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_PC_jump_adder_Register: PipelineRegister_Flush
    generic map (N => 32)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_AndLink_Register: PipelineRegister_Flush
    generic map (N => 2)
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
  ...
  EXMEM_ALU_Flag_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_WriteEnable_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_Shift_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_Halt_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_Branch_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_Jump_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_FlagNFlag_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_MemWrite_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
  ...
  EXMEM_MemToReg_Register: PipelineRegister_logic_Flush
    port map (
      i_CLK   => i_CLK,
      i_RST   => i_RST,
      i_WE    => '1',
